/*---------------------------------------------
* 计算机图形学-LearnOpenGL-1.6.入门-纹理-练习4
* 画一个矩形
* 添加两张纹理，叠加
* 练习4，添加uniform变量，通过键盘调整融合度
* @author ZhaoHeln 2018年3月25日16:36:17
---------------------------------------------*/
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform1f(glGetUniformLocation(myShader.ID, "mixPercent"), mixPercent/100.0f); // 手动设置
